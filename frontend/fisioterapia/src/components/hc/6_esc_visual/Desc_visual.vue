              ...
              <div class="row">
                <div class="col-12 col-md-4">
                  ...
                  <div class="controls mt-2">
                    ...
                    <span class="ms-2"
                      >{{ getMarcadoresPorImagen("imagen1").length }} marcador(es)</span
                    >
                  </div>
                </div>
                <div class="col-12 col-md-4 position-relative">
                  ...
                  <div class="controls mt-2">
                    ...
                    <span class="ms-2"
                      >{{ getMarcadoresPorImagen("imagen2").length }} marcador(es)</span
                    >
                  </div>
                </div>
                <div class="col-12 col-md-4 position-relative">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-floating mb-3">
                    <textarea
                      class="form-control mb-3"
                      id="text_diagnosticomedico4"
                      rows="2"
                      placeholder="Localización"
                      v-model="Localización"
                    ></textarea>
                ...
                <div class="col-md-6">
                  <div class="form-floating mb-3">
                    <textarea
                      class="form-control mb-3"
                      id="text_diagnosticomedico7"
                      rows="2"
                      placeholder="Atenuación"
                      v-model="Atenuación"
                    ></textarea>
                ...
                <div class="col-md-12">
                  <div class="form-floating mb-3">
                    <textarea
                      class="form-control mb-3"
                      id="text_diagnosticomedico9"
                      rows="2"
                      placeholder="Actividades que le cuesta realizar"
                      v-model="Actividades"
                    ></textarea>
                    <label for="text_diagnosticomedico9"
                      >Actividades que le cuesta realizar</label
                    >
                  </div>
                </div>
              </div>
