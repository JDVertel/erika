  ...
  <div>
    <div class="container-fluid Cont_hc">
      ...
      <div
        ...
        v-if="idpaciente && idprofesional && idips && this.StateNumRegHC"
      >
        <C_Hc
...
export default {
  ...
  methods: {
    ...
    /*   consultarDatosPaciente() {
            // Lógica para consultar datos del paciente
        },
        consultarDatosprofesional() {
            // Lógica para consultar datos del profesional
        },
        consultarDatosIPS() {
            // Lógica para consultar datos de la IPS
        }, */
  },
  computed: {
    ...
    idfactura() {
      return this.StateNumRegHC && this.StateNumRegHC[0].idHC
        ? this.StateNumRegHC[0].idHC
        : null;
    },
  },
