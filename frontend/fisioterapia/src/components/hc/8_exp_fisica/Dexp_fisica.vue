              ...
              <div class="col-12 col-md-4">
                ...
                <table class="table table-sm table-success">
                    ...
                    <tr>
                      ...
                      <th>
                        <input
                          ...
                          v-model="data_izquierdo1"
                          v-if="data_movimiento1 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    <!--  -->
                    <tr
                      v-for="(item, index) in this.array_RAQUISCERVICAL_Data"
                      :key="index"
                    >
                      <td>{{ item.movimiento }}</td>
                      <td>Izq: {{ item.derecho }}</td>
                      <td>Der: {{ item.izquierdo }}</td>

                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray1(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
              ...
              <div class="col-12 col-md-4">
                ...
                <table class="table table-sm table-success">
                    ...
                    <tr>
                      <th>
                        <select
                          class="form-select form-select-sm"
                          aria-label="Small select example"
                          v-model="data_movimiento2"
                          @change="handleSelectChange2"
                        >
                          <option selected value="">-Seleccione Movimiento-</option>
                          <option
                            v-for="(item, index) in this.array_RAQUISDORSOLUMBAR"
                            :key="index"
                            :value="item"
                          >
                            {{ item }}
                      ...
                      <th>
                        <input
                          ...
                          id="exampleFormControlInput1"
                          placeholder="-Izquierdo-"
                          v-model="data_izquierdo2"
                          v-if="data_movimiento2 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    <!--  -->
                    <tr
                      v-for="(item, index) in this.array_RAQUISDORSOLUMBAR_Data"
                      :key="index"
                    >
                      <td>{{ item.movimiento }}</td>
                      <td>Izq: {{ item.derecho }}</td>
                      ...
                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray2(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
                    ...
                    <tr>
                      <th>
                        <select
                          class="form-select form-select-sm"
                          aria-label="Small select example"
                          v-model="data_movimiento3"
                          @change="handleSelectChange3"
                        >
                          <option selected value="">-Seleccione Movimiento-</option>
                          <option
                            v-for="(item, index) in this.array_HOMBRO"
                            :key="index"
                            :value="item"
                          >
                            {{ item }}
                      ...
                      <th>
                        <input
                          ...
                          id="exampleFormControlInput1"
                          placeholder="-Izquierdo-"
                          v-model="data_izquierdo3"
                          v-if="data_movimiento3 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    ...
                    <tr v-for="(item, index) in this.array_HOMBRO_Data" :key="index">
                      ...
                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray3(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
                    ...
                    <tr>
                      <th>
                        <select
                          class="form-select form-select-sm"
                          aria-label="Small select example"
                          v-model="data_movimiento4"
                          @change="handleSelectChange4"
                        >
                          <option selected value="">-Seleccione Movimiento-</option>
                          <option
                            v-for="(item, index) in this.array_CODO"
                            :key="index"
                            :value="item"
                          >
                            {{ item }}
                      ...
                      <th>
                        <input
                          ...
                          id="exampleFormControlInput1"
                          placeholder="-Izquierdo-"
                          v-model="data_izquierdo4"
                          v-if="data_movimiento4 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    ...
                    <tr v-for="(item, index) in this.array_CODO_Data" :key="index">
                      ...
                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray4(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
                    ...
                    <tr>
                      <th>
                        <select
                          class="form-select form-select-sm"
                          aria-label="Small select example"
                          v-model="data_movimiento5"
                          @change="handleSelectChange5"
                        >
                          <option selected value="">-Seleccione Movimiento-</option>
                          <option
                            v-for="(item, index) in this.array_MUNECA"
                            :key="index"
                            :value="item"
                          >
                            {{ item }}
                      ...
                      <th>
                        <input
                          ...
                          id="exampleFormControlInput1"
                          placeholder="-Izquierdo-"
                          v-model="data_izquierdo5"
                          v-if="data_movimiento5 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    ...
                    <tr v-for="(item, index) in this.array_MUNECA_Data" :key="index">
                      ...
                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray5(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
                    ...
                    <tr>
                      <th>
                        <select
                          class="form-select form-select-sm"
                          aria-label="Small select example"
                          v-model="data_movimiento6"
                          @change="handleSelectChange6"
                        >
                          <option selected value="">-Seleccione Movimiento-</option>
                          <option
                            v-for="(item, index) in this.array_CADERA"
                            :key="index"
                            :value="item"
                          >
                            {{ item }}
                      ...
                      <th>
                        <input
                          ...
                          id="exampleFormControlInput1"
                          placeholder="-Izquierdo-"
                          v-model="data_izquierdo6"
                          v-if="data_movimiento6 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    ...
                    <tr v-for="(item, index) in this.array_CADERA_Data" :key="index">
                      ...
                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray6(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
                    ...
                    <tr>
                      <th>
                        <select
                          class="form-select form-select-sm"
                          aria-label="Small select example"
                          v-model="data_movimiento7"
                          @change="handleSelectChange7"
                        >
                          <option selected value="">-Seleccione Movimiento-</option>
                          <option
                            v-for="(item, index) in this.array_RODILLA"
                            :key="index"
                            :value="item"
                          >
                            {{ item }}
                      ...
                      <th>
                        <input
                          ...
                          id="exampleFormControlInput1"
                          placeholder="-Izquierdo-"
                          v-model="data_izquierdo7"
                          v-if="data_movimiento7 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    ...
                    <tr v-for="(item, index) in this.array_RODILLA_Data" :key="index">
                      ...
                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray7(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
                    ...
                    <tr>
                      <th>
                        <select
                          class="form-select form-select-sm"
                          aria-label="Small select example"
                          v-model="data_movimiento8"
                          @change="handleSelectChange8"
                        >
                          <option selected value="">-Seleccione Movimiento-</option>
                          <option
                            v-for="(item, index) in this.array_TOBILLO"
                            :key="index"
                            :value="item"
                          >
                            {{ item }}
                      ...
                      <th>
                        <input
                          ...
                          id="exampleFormControlInput1"
                          placeholder="-Izquierdo-"
                          v-model="data_izquierdo8"
                          v-if="data_movimiento8 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    ...
                    <tr v-for="(item, index) in this.array_TOBILLO_Data" :key="index">
                      ...
                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray8(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
              ...
              <div class="col-12 col-md-3">
                ...
                <table class="table table-sm table-success">
                    ...
                    <tr>
                      <th>
                        <select
                          class="form-select form-select-sm"
                          aria-label="Small select example"
                          v-model="data_movimiento9"
                          @change="handleSelectChange9"
                        >
                          <option selected value="">-Seleccione Movimiento-</option>
                          <option
                            v-for="(item, index) in this.array_ART_SUBASTRAGALINA"
                            :key="index"
                            :value="item"
                          >
                            {{ item }}
                      ...
                      <th>
                        <input
                          ...
                          id="exampleFormControlInput1"
                          placeholder="-Izquierdo-"
                          v-model="data_izquierdo9"
                          v-if="data_movimiento9 !== ''"
                        />
                      </th>
                      <th>
                        <input
                  ...
                  <tbody>
                    <!--  -->
                    <tr
                      v-for="(item, index) in this.array_ART_SUBASTRAGALINA_Data"
                      :key="index"
                    >
                      <td>{{ item.movimiento }}</td>
                      <td>Izq: {{ item.derecho }}</td>
                      ...
                      <td>
                        <button
                          class="btn btn-sm btn-danger"
                          @click="deleteItemarray9(index, item.movimiento)"
                        >
                          <i class="bi bi-trash-fill"></i>
                        </button>
                      </td>
