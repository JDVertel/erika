      ...
      >
        ...
        <div class="card">
          <div v-if="datapaciente.length == 0">
            ...
            <p class="card-text">
              Ingrese la identificacion del cliente para facturar el producto o servicio
            </p>
          ...
          <div class="container" v-if="this.existepaciente == 1">
            <div>
              ...
              <div
                ...
                style="background-color: #e8f0a3; border-radius: 5px; padding: 10px"
              >
                <div class="row">
                  <!--  <h5><i class="bi bi-cart-plus"></i> Factura</h5> -->
                  <h6>Agregar items</h6>
                  <!-- categoria -->
                  ...
                  <!--  Articulo/servicio -->
                  <div class="col-6 col-md-3 mb-2">
                    <label for="inputGroupSelect02">Nombre</label>
                    <select
                      class="form-select form-select-sm textarea"
                      id="inputGroupSelect02"
                      v-model="selec_prod"
                      @change="FiltrarCombos(this.select_categ, this.selec_prod.nombre)"
                    >
                      <option value="">---Seleccione---</option>
                      <option
                        :value="{ nombre: desc.nombre, precio: desc.precio }"
                        v-for="(desc, index) in filtro"
                        :key="index"
                      >
                        {{ desc.nombre }}
                      </option>
                  ...
                  >
                    ...
                    >
                      <option value="">---Seleccione---</option>
                      <option
                        :value="{ precio: combo.precio, cant: combo.cant }"
                        v-for="(combo, index) in selectcombo"
                        :key="index"
                      >
                  ...
                  <div class="col-3 col-md-1 mt-3">
                    ...
                    <button
                      class="btn btn-warning btn-sm mt-2"
                      @click="AddArticulo"
                      v-if="cantFact > 0 && select_categ == 'producto'"
                    >
                      <i class="bi bi-cart-plus"></i>
                    </button>
                  </div>
            ...
            <h5><i class="bi bi-cash-coin"></i> Detalle de factura</h5>
            ...
            <div class="row">
              <button
                ...
                @click="crearNuevoRegistroFactura(40)"
              >
                <i class="bi bi-floppy"></i> Facturar
              </button>
            </div>
            <hr />
          </div>
      ...
      <div class="col-sm-6 col-md-8">
        <div class="container">
          ...
          <table class="table table-sm table-striped">
            ...
            <tbody>
              <tr v-for="(item, index) in this.StateFacturasDiarias[0]" :key="index">
                <td>{{ item.idpac }}</td>
                <td>
                  <ul class="list-group list-group-flush">
                    <li
                      class="list-group-item"
                      v-for="(subItem, subIndex) in item.detalle"
                      :key="subIndex"
                    >
                      cant: {{ subItem.cant }} / combo:{{ subItem.combo }} / nombre:{{
                        subItem.nombre
                      }}
